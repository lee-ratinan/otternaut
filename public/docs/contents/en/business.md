...
| Detail    | Original File Requirements | Final File Format |
|-----------|----------------------------|-------------------|
| File Type | JPG, PNG, WEBP             | WEBP              |
| Size      | max 1000 KB                | n/a               |
| Dimension | max 1200px x 1200px        | 1000px x 1000px   |
...
|-----------|----------------------------|-------------------|
| File Type | JPG, PNG, WEBP             | WEBP              |
| Size      | max 1500 KB                | n/a               |
| Dimension | max 2500px x 1500px        | 1200px x 800px    |
